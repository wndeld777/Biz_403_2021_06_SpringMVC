...
public class GalleryController {
	 ...
	 * localhost:8080/rootPath/gallery/dumy 로 요청할때 Request를 처리
	...
	public String input(Model model) {
		...
		GalleryDTO gaDTO = GalleryDTO.builder().g_date(curDate).g_time(curTime).g_writer("wndeld777").build();
