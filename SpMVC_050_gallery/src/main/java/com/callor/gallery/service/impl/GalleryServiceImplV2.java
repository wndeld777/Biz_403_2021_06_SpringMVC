...
public class GalleryServiceImplV2 extends GalleryServiceImplV1{
	...
	/*
	 * @RequireArgConstructor 문제로 상속받은 클래스에서 강제로 생성자 만들어야 함
	 */
	
	public GalleryServiceImplV2(GalleryDao gaDao, FileDao fDao,@Qualifier("fileServiceV2") FileService fService) {
