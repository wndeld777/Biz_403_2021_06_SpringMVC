 ...
 * 보관해 달라 라는 지시어
 * 
 * CompVO c = new CompVO() -> 권장
 * Object o = new CompVO()
 * 
 * CompServiceImplV1 cs = new CompServiceImplV1();
 * CompService cs1 = new CompServiceImplV1(); -> 권장(인터페이스)
 */
...
public class CompDaoImplV1 implements CompDao{
	 ...
	 * 
	 * vo 에 담겨서 전달된 값은 Object[] 배열로 변환한 후
	...
	public List<CompVO> findByCName(String cname) {
		...
		// SELECT를 수행한 후 각각의 데이터를 CompVO 에 담고
		// List 에 add 하여 return한 후 compList에 받기
