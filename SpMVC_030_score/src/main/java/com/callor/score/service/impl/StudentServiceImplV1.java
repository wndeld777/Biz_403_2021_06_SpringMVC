...
public class StudentServiceImplV1 implements StudentService{
	 ...
	 * 업무가 정상으로 수행된다.
	 * 
	 * 업무가 수행되는 동안 한곳이라도 CUD에서
	 * 오류가 발생하면 CUD가 진행되는 동안
	 * 문제가 발생하고 데이터에 오류가 저장될것이다
	 * 
	 * 이런 상황을 방지하기 위하여
