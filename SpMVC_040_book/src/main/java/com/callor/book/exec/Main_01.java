...
public class Main_01 {
	...
	public static void main(String[] args) {
		...
		// 일부데이터를 위하여 별도록 생성자를 또 만들어야 한다
		// 데이터의 주입 순서가 바뀌면 어떤 값이 저장될지 모른다
		// 전적으로 개발자 책임으로 귀결된다
		BookDTO bookDTO1 = new BookDTO("자바야놀자", "linke", "image", "author", "price", "discount", "publisher", "isbn",
				"desc", "pubdate");
		...
		// 장점 : 1. new 키워드로 생성자를 호출하지 않는다
		// 		  2. 필요한 변수(속성, 맴버변수)만 가지고 있는 객체를 만들수 있다
		// 		  3. 변수이름을 직접 호출하는 방식으로 값을 저장할 수 있다
		BookDTO bookDTO2 = BookDTO.builder().title("자바야놀자").price("20000").isbn("9760000").build();
